...
CREATE TABLE IF NOT EXISTS employees(
	...
	state int(2) NOT NULL,/*enumerated below*/
	...
	salary int NOT NULL,
	role int(2) NOT NULL,/*enumerated below*/
...
CREATE TABLE IF NOT EXISTS transactions(
	...
	transaction_type int(2) NOT NULL,/*enumerated below*/
...
CREATE TABLE IF NOT EXISTS species(
	...
	behavior int(2), /*enumerated below*/
